...
internal sealed record InstallationToken(string Token, DateTimeOffset ExpiresAt);
...
/// </summary>
internal sealed class GitHubAppAuthenticator
{
        ...
        string jwt, string owner, bool isOrganization, CancellationToken cancellationToken)
    {
        ...
        throw new GitHubApiException(
            ...
            "Set GitHubApp:Owner (and OwnerType) to one of the above, or install the App on that owner.",
            response.StatusCode);
    }
